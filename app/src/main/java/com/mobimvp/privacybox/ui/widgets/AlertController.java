...
public class AlertController {
    ...
    private View interval1;
    private View interval2;
    ...
    public void installContent() {
        ...
        mWindow.setContentView(R.layout.widget_alert_dialog);
        setupView();
    }
    ...
    private void setupView() {
        ...
        interval1 = mWindow.findViewById(R.id.view1);
        interval2 = mWindow.findViewById(R.id.view2);
		 ...
		 */
		/*
		 * if (hasTitle && ((mMessage != null) || (mView != null))) { View
    ...
    private boolean setupButtons() {
        ...
        if ((!TextUtils.isEmpty(mButtonPositiveText) && !TextUtils.isEmpty(mButtonNegativeText)) ||
                (!TextUtils.isEmpty(mButtonPositiveText) && !TextUtils.isEmpty(mButtonNeutralText))) {
            interval1.setVisibility(View.VISIBLE);
        }
        if (!TextUtils.isEmpty(mButtonNeutralText) && !TextUtils.isEmpty(mButtonNegativeText)) {
            interval2.setVisibility(View.VISIBLE);
        }
    ...
    private void setBackground(LinearLayout topPanel, LinearLayout contentPanel, View customPanel, boolean hasButtons, TypedArray a, boolean hasTitle, View buttonPanel) {
        ...
        int fullDark = a.getResourceId(R.styleable.AlertDialog_fullDark, R.drawable.dialog_bg_nt);
        int topDark = a.getResourceId(R.styleable.AlertDialog_topDark, R.drawable.dialog_bg_top);
        int centerDark = a.getResourceId(R.styleable.AlertDialog_centerDark, R.drawable.dialog_bg_center);
        int bottomDark = a.getResourceId(R.styleable.AlertDialog_bottomDark, R.drawable.dialog_bg_bottom);
        int fullBright = a.getResourceId(R.styleable.AlertDialog_fullBright, R.drawable.dialog_bg_nt);
        int topBright = a.getResourceId(R.styleable.AlertDialog_topBright, R.drawable.dialog_bg_top);
        int centerBright = a.getResourceId(R.styleable.AlertDialog_centerBright, R.drawable.dialog_bg_center);
        int bottomBright = a.getResourceId(R.styleable.AlertDialog_bottomBright, R.drawable.dialog_bg_bottom);
        int bottomMedium = a.getResourceId(R.styleable.AlertDialog_bottomMedium, R.drawable.dialog_bg_bottom);
    ...
    private static final class ButtonHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                // 防止java.lang.NullPointerException异常抛出
                case DialogInterface.BUTTON_POSITIVE:
                case DialogInterface.BUTTON_NEGATIVE:
                case DialogInterface.BUTTON_NEUTRAL:
                    if (mDialog != null && msg.obj != null)
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController dialog) {
            final RecycleListView listView = (RecycleListView) mInflater.inflate(R.layout.widget_select_dialog, null);
            ListAdapter adapter;

            if (mIsMultiChoice) {
                if (mCursor == null) {
                    adapter = new ArrayAdapter<CharSequence>(mContext, R.layout.widget_select_dialog_multichoice, R.id.text1, mItems) {
                        @Override
                    ...
                    adapter = new CursorAdapter(mContext, mCursor, false) {
                        ...
                        public View newView(Context context, Cursor cursor, ViewGroup parent) {
                            return mInflater.inflate(R.layout.widget_select_dialog_multichoice, parent, false);
                        }

                    };
                }
            } else {
                int layout = mIsSingleChoice ? R.layout.widget_select_dialog_singlechoice : R.layout.widget_select_dialog_item;
                if (mCursor == null) {
