 ...
 */
public class AlertDialogLite extends Dialog implements DialogInterface {
    private AlertController mAlert;

    protected AlertDialogLite(Context context) {
        this(context, R.style.PRIVACYBOX_Theme_Dialog_Alert);

    }

    protected AlertDialogLite(Context context, int theme) {
        super(context, theme);
        mAlert = new AlertController(context, this, getWindow());
    }

    protected AlertDialogLite(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, R.style.PRIVACYBOX_Theme_Dialog_Alert);
    ...
    public void show() {
        try {
            ...
            e.printStackTrace();
            cancel();
            // 常见异常：BadTokenException: Unable to add window
        }
    }
    ...
    public static class Builder {
         ...
         * @param listener    The listener that will be called when an item is clicked.
         * @param labelColumn The column name on the cursor containing the string to
         ...
         * @param isCheckedColumn specifies the column name on the cursor to use to
        ...
        public Builder setCanceledOnTouchOutside(boolean enabled) {
            P.mCanceledOnTouchOutside = enabled;
            return this;
        }
         ...
         */
        public AlertDialogLite create() {
            final AlertDialogLite dialog = new AlertDialogLite(P.mContext);
            ...
            //czz:必须先设置setCanceledOnTouchOutside，再设置setCancelable
         ...
         */
        public AlertDialogLite show() {
            AlertDialogLite dialog = create();
            dialog.show();
            return dialog;
        }
    }
